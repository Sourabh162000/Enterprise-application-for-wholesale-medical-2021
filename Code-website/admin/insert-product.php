...
if(!is_dir($dir)){
	...
	$S = "insert into products(category,subCategory,productName,productCompany,productDescription,productAvailability,productImage1) values('$category','$subcat','$productname','$productcompany','$productdescription','$productavailability','$productimage1')";
