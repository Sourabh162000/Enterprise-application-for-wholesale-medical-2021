				...
				<div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
					...
					<div class="logo">
						<a href="index.php">
							...
							<h2>Novamed Pharma</h2>

						</a>
					</div>		
				</div>
				<div class="col-xs-12 col-sm-12 col-md-6 top-search-holder" style="padding-top: 15px;">
...
<!-- ============================================================= SEARCH AREA : END ============================================================= -->				
				...
				<div class="col-xs-12 col-sm-12 col-md-3 animate-dropdown top-cart-row" style="padding-top: 25px;">
