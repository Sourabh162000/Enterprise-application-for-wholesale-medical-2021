...
if (isset($_SESSION['cart'])) {
	foreach ($_SESSION['cart'] as $key => $value) {
		...
		{
			$No = (INT)$_SESSION['cart'][$key]['quantity'];
			if ($No<5) {
				$_SESSION['cart'][$key]['quantity'] = 5;
			}
		}
	}
}
...
<div class="form-group">
			 ...
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="shippingstate" value="<?php echo $row['shippingState']; ?>" required>
					  </div>
					  <div class="form-group">
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Total Quantity : <span class="inner-left-md"><?php echo $totalqunty; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
